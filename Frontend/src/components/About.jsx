...
const AboutUs = () => {
    return (
        <div className="container mx-auto my-12 px-4 py-8 dark:text-white ">
            ...
            <div className="contact-info mt-6">
                ...
                <p className="text-lg ">Phone: <a href="tel:+1234567890" className="text-blue-500">+1 (234) 567-890</a></p>
                <p className="text-lg ">Address: XYZ Nagar, New Delhi, 202220 </p>
            </div>
        </div>
    );
};
